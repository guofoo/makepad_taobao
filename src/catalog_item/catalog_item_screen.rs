            ...
            sections = <View> {
                ...
                <Section> {
                    price_container = <View> {
                        width: Fit, height: Fit
                        align: {y: 0.5}, flow: Right, spacing: 5.
                        <Label> {
                            width: Fit, height: Fit
                            text: "¥50"
                            draw_text: {
                ...
                <Section> {
                    ...
                    <View> {
                        width: Fill, height: Fit
                        flow: Down, spacing: 20., padding: {top: 20, left: 15, right: 15, bottom: 25}
                        show_bg: true
                        draw_bg: {
                            instance radius: 5.
                        ...
                        <View> {
                            ...
                            <View> {
                                ...
                                <View> {
                                    ...
                                    <RoundedView> {
                                        width: Fit, height: Fit
                                        spacing: 5., align: {y: 0.5}, padding: {right: 6., left: 6., top: 3, bottom: 3}
                                        draw_bg: {
                                            color: #43,
                                            radius: 4.
                                        }
                        ...
                        <View> {
                            width: Fill, height: Fit
                            flow: Right, spacing: 5., align: {x: 0.5}
                            <RoundedView> {
                                width: Fit, height: Fit
                    ...
                    <View> {
                        width: Fill, height: Fit
                        flow: Down, spacing: 5., align: {x: 0.5}
