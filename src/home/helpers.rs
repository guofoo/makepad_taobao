...
live_design! {
    ...
    IconWithText = <View> {
        ...
        flow: Down, align: {x: 0.5, y: 0.5}, spacing: 5.0
    ...
    FeaturedBox = <RoundedView> {
        ...
        flow: Down, align: {x: 0.0, y: 0.0}, spacing: 2.0, padding: 6.0
        ...
        content = <View> {
            ...
            image_container_1 = <View> {
                ...
                flow: Down, align: {x: 0.5, y: 0.0}, spacing: 5.0
                <FillerY> {}
                image = <Image> {
                }
                <FillerY> {}
    ...
    FeaturedBoxWithHighlightBox = <FeaturedBox> {
        header = {
            highlight = <RoundedView> {
                width: Fit, height: Fit, margin: {left: 6.}
                flow: Right,
                align: {x: 0.0, y: 0.0},
